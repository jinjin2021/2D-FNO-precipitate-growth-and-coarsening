...
#Each of these variables holds the sum of the corresponding loss over all batches.
    ...
    save_checkpoint(config['train']['save_dir'],
                    ...
                    model, optimizer)
    print('Done!')
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/Train_loss.pkl','wb') as f:
        pkl.dump(Tloss,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/D_CH.pkl','wb') as f:
        pkl.dump(Dloss_CH,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/D_AC.pkl','wb') as f:
        pkl.dump(Dloss_AC,f)
    return
...
def eval_burgers2D_vec_pad(model,
    ...
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/meanTotal_err.pkl','wb') as f:
        pkl.dump(meanTotal_err,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/stdTotal_err.pkl','wb') as f:
        pkl.dump(stdTotal_err,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/meanc_err.pkl','wb') as f:
        pkl.dump(meanc_err,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/stdc_err.pkl','wb') as f:
        pkl.dump(stdc_err,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/meaneta_err.pkl','wb') as f:
        pkl.dump(meaneta_err,f)
    with open(f'/home/ggangmei/my-vast/FNO_EAAI/{folder}/stdeta_err.pkl','wb') as f:
